...
import Container, { ContainerProps, NewChild } from 'postcss/lib/container'ostcss/lib/list'
import Node, {
  Source,
  AnyNode,
  Position,
  ...
  ChildProps,
  NodeErrorOptions,
} from 'postcss/lib/node''postcss/lib/node'
...
import Warning, { WarningOptions } from 'postcss/lib/warning'Options } from 'postcss/lib/warning'
